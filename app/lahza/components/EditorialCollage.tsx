      ...
      <div className='max-w-[1400px] mx-auto px-4'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8 items-center'>
          ...
          <div className='md:col-span-4 flex flex-col gap-6 md:gap-8'>
            ...
            >
              <Image
                src='https://ik.imagekit.io/weddingtheory/Photos/S&CPREWEDFIRSTSET-6.JPG?updatedAt=1730140170874'
            ...
            >
              <Image
                src='https://ik.imagekit.io/weddingtheory/Photos/M&PEngagement-245%20(1).jpg?updatedAt=1730140149027'
